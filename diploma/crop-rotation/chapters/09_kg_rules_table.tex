...
\texttt{fallow\_break\_effect}
  & Поддерживающий сигнал при переходе от пара к культуре или предупреждение при повторном выборе пара
  & Поддерживающий / предупреждающий \\
\texttt{region\_typicality}
  & Поддерживающий сигнал для культур, типичных для региона по статистике
  & Поддерживающий \\
\bottomrule
\end{tabular}
\end{table}
