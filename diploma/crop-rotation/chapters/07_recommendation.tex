...
\subsection{Результаты CatBoost в рекомендательном режиме}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4706}}
...
\bottomrule\noalign{}
\endlastfoot
catboost\_recommendation\_baseline & validation & 0.699281 & 0.951190 & 0.990794 \\
\end{longtable}
}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.5079}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0794}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1587}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1270}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1270}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
model
...
\bottomrule\noalign{}
\endlastfoot
catboost\_recommendation\_baseline & test & 0.699006 & 0.951236 & 0.990819 \\
\end{longtable}
}
...
\subsection{Сравнение с Markov-1 baseline}
...
\subsubsection{Validation и test}
...
\bottomrule\noalign{}
\endlastfoot
markov\_1\_recommendation\_baseline & validation & 0.541749 & 0.854177 & 0.935645 \\
markov\_1\_recommendation\_baseline & test & 0.541804 & 0.854223 & 0.935550 \\
\end{longtable}
}
